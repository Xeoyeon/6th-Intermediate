## EURON 6th - Intermediate Session (Deep Learning)

This repository contains my organized study notes and assignments from the **Deep Learning Specialization** by Prof. Andrew Ng. 
<br><br>

#### Course Info
* **Instructor:** Prof. Andrew Ng
* **Content:** Deep Learning fundamentals, Neural Networks, Hyperparameter tuning, and Optimization.
* **Source:** [[Neural Networks and Deep Learning]([https://www.youtube.com/playlist?list=PLp7pS0p6pC2BAsiW7A6_n_UbeD4zYf0qG](https://www.youtube.com/playlist?list=PLkDaE6sCZn6Ec-XTbcX1uRg2_u4xOEky0))](https://youtube.com/playlist?list=PLkDaE6sCZn6Ec-XTbcX1uRg2_u4xOEky0&si=Vk6UwSpMQzFqE5Rz)

<br><br>

### **📂 Weekly Curriculum & Study Notes**

The following table summarizes the weekly topics covered during the session. Detailed notes and code for each week can be found in their respective branches.
